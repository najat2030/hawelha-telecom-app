...
def create_record(phone, v):
    # التأكد من وجود 13 قيمة لتجنب أخطاء المصفوفة
    if len(v) < 13:
        v = v + [0.0] * (13 - len(v))
    ...
    return {
        ...
        'إجمالي': v[0],
        'قيمة الضرائب': v[1],
        'رسوم وتسويات اخرى': v[2],
        'رسوم تجوال - إنترنت': v[3],
        'رسوم تجوال - رسائل': v[4],
        'رسوم تجوال - مكالمات': v[5],
        'رسوم دولية - رسائل': v[6],
        'رسوم دولية - مكالمات': v[7],
        'رسوم محلية - إنترنت': v[8],
        'رسوم محلية - رسائل': v[9],
        'رسوم محلية - مكالمات': v[10],
        'رسوم الخدمات': v[11],
        'رسوم شهرية': v[12]
    }
        ...
        with st.spinner('⏳ جاري معالجة الملف...'):
            ...
            try:
                ...
                if records:
                    ...
                    columns_order = [
                        'محمول', 'إجمالي', 'قيمة الضرائب', 'رسوم وتسويات اخرى', 
                        'رسوم تجوال - إنترنت', 'رسوم تجوال - رسائل', 'رسوم تجوال - مكالمات', 
                        'رسوم دولية - رسائل', 'رسوم دولية - مكالمات', 
                        'رسوم محلية - إنترنت', 'رسوم محلية - رسائل', 'رسوم محلية - مكالمات', 
