...
# ========== دوال المعالجة ==========
# ترتيب الأعمدة النهائي المطلوب في الإكسل (نفس ترتيب الصورة المرفقة من اليمين لليسار)
# ملاحظة: في الباندا (DataFrame) نرتبها من اليمين لليسار
FINAL_COLUMNS_ORDER = [
    'محمول', 
    'رسوم شهرية', 
    'رسوم الخدمات', 
