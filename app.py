...
def extract_numbers(text):
    ...
    text = re.sub(r'(\d)\-', r'\1 -', text) # تحسين معالجة السالب الملتصق
...
def parse_en(file):
    # هنا تضع لوجيك اللغة الإنجليزية إذا كان متاحاً أو تتركها تعود لـ parse_ar حالياً
    return parse_ar(file)
